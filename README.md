...
`VLSI` · `DFT` · `Digital Design` · `Semiconductor Technology`

---

I am an Electronics & VLSI Engineering student interested in  
**VLSI design, semiconductor systems, digital hardware, and research.**

Currently exploring **DFT, RTL design, hardware optimization, and intelligent computing.**

---

`Verilog` `SystemVerilog` `Python` `C/C++` `Cadence` `VLSI` `DFT`
